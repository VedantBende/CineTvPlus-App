      ...
      <div className="container-custom py-8 sm:py-10 md:py-12">
          ...
          {query ? (
            <>
              ...
              <div className="flex items-center gap-3 mt-3">
                <h2 className="text-gray-600 dark:text-gray-300 text-base sm:text-lg md:text-xl transition-colors">
                  Showing matches for <span className="text-accent-red font-semibold transition-colors">"{query}"</span>
                </h2>
                {results.length > 0 && (
            ...
            <h1 className="text-gray-900 dark:text-white text-2xl sm:text-3xl md:text-4xl font-bold transition-colors">
              Search
            </h1>
          )}
        </div>
        ...
        {loading && page === 1 ? (
          ...
          <div className="text-center py-16 sm:py-20">
            ...
            <h2 className="text-gray-900 dark:text-white text-xl sm:text-2xl font-semibold mb-2 transition-colors">No results found</h2>
            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base transition-colors">Try searching with different keywords</p>
          </div>
        ) : (
          <div className="text-center py-16 sm:py-20">
            <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-6 rounded-full bg-gray-100 dark:bg-gray-800/50 flex items-center justify-center transition-colors">
            ...
            <h2 className="text-gray-900 dark:text-white text-xl sm:text-2xl font-semibold mb-2 transition-colors">Start searching</h2>
            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base transition-colors">Enter a movie or TV show name to search</p>
          </div>
        )}
      </div>
    </div>
