...
export default function InstallPWA() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden md:block overflow-hidden whitespace-nowrap transition-all duration-300 ease-in-out max-w-0 opacity-0 group-hover:max-w-xs group-hover:opacity-100 group-hover:ml-1.5">
        Install App
      </span>
    </button>
  );
