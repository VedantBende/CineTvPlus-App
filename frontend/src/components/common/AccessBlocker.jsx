    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] text-white px-4 text-center">
        <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-xl max-w-md w-full">
          ...
          <div className="bg-black/40 p-3 rounded mb-6 text-left overflow-auto max-h-32 border border-red-500/20">
            <p className="text-red-400 text-sm font-mono break-words">{syncError}</p>
          </div>
          <button 
          ...
          <p className="text-zinc-500 text-xs">If this continues, check backend console logs.</p>
        </div>
      </div>
    );
  }
