...
- **Multi-Server UI**: Users pick and freely toggle between multiple abstracted servers (Alpha, Beta, Gamma, Delta, Epsilon, Zeta, Eta) safely storing their preference for fallback streaming capability.
